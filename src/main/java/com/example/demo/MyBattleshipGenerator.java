...
public class MyBattleshipGenerator implements BattleshipGenerator{
    ...
    @Override
    public String generateOpponentMap() {
        StringBuilder stringBuilder = new StringBuilder();
        stringBuilder.append("?".repeat(10).repeat(10));
        return stringBuilder.toString();
    }
